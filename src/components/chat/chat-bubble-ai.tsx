  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start flex-1 min-w-0">
        <div className="bg-brand-card border border-brand-border text-slate-100 rounded-lg rounded-tl-[4px] rtl:rounded-tl-[20px] rtl:rounded-tr-[4px] px-4 py-3 shadow-md text-sm sm:text-base leading-relaxed break-words">
          {message}
        </div>
        {timestamp && (
