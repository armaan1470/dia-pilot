...
export const BottomNavigation: React.FC<BottomNavigationProps> = ({
  ...
  return (
    <nav
      ...
      className={cn(
        "fixed bottom-0 left-0 right-0 w-full z-40 bg-brand-dark/95 backdrop-blur-2xl rounded-t-3xl border-t border-brand-border px-4 pt-2 pb-[max(0.75rem,env(safe-area-inset-bottom,0px))] transition-all duration-300 flex-shrink-0",
        className
      )}
    >
